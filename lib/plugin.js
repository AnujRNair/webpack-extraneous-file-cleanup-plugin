...
function ExtraneousFileCleanupPlugin (options) {
  ...
  this.ignoreGlob = options.ignoreGlob || []
  this.ignoreGlobOptions = options.ignoreGlobOptions || {}
}
...
ExtraneousFileCleanupPlugin.prototype.afterEmit = function (compilation) {
  ...
  Object.keys(compilation.assets).forEach(assetKey => {
    ...
    if (this.ignoreGlob.length && micromatch([assetKey], this.ignoreGlob, this.ignoreGlobOptions).length > 0) {
      return
    }
